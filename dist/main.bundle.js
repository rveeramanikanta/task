...
var AppComponent = (function () {
    function AppComponent(_http) {
        ...
        this.borderColors = ["red", "green", "blue", "orange"];
        this.colorCounter = 0;
        this.chartData = {
            labels: [],
            datasets: []
    ...
    AppComponent.prototype.convertFile = function (csv) {
        var _this = this;
            ...
            for (var i = 0; i < allTextLines.length; i++) {
                ...
                if (data.length === headers.length) {
                    ...
                    for (var j = 1; j < headers.length; j++) {
                        var scoreYear = data[j].split("|");
                        serires[scoreYear[0]] = scoreYear[1];
                        scores.push(scoreYear[1]);
                        if (_this.chartData.labels.indexOf(scoreYear[0]) == -1) {
                            _this.chartData.labels.push(scoreYear[0]);
                    ...
                    _this.chartData.datasets.push({
                        ...
                        data: scores,
                        fill: true,
                        borderColor: _this.borderColors[_this.colorCounter++]
                    });
                }
            }
            console.log(finalJSON);
            _this.isUploded = true;
            _this._http.post("/charts", finalJSON)
